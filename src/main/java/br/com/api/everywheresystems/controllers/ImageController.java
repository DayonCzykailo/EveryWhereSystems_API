...
public class ImageController {
    ...
    public ImageController(AccontService loginService, ImageService imageService) {
        this.loginService = loginService;
        this.imageService = imageService;
    }

    @GetMapping(Endpoints.imagefindAll) // tirar funcoes de imagem daqui
    ...
    @GetMapping(Endpoints.imagefindById)
    ...
    @PutMapping(Endpoints.imagefindById)
    ...
    @PostMapping(Endpoints.imageCreate) // tirar funcoes de imagem daqui
