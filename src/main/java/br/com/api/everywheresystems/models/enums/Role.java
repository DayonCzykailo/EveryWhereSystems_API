...
public enum Role {
    ...
    public static final List<String> listUsers = Arrays.asList("ADMIN", "SUB_USER", "ACCESS_USERS");
    public static final List<String> listManageUser = Arrays.asList("ADMIN", "SUB_USER", "ACCESS_MANAGE_USERS");
    public static final List<String> listRegisterUser = Arrays.asList("ADMIN", "SUB_USER", "ACCESS_REGISTER_USERS");

    public static final List<String> listClients = Arrays.asList("ADMIN", "SUB_USER", "ACCESS_CLIENTS");
    public static final List<String> listManageClients = Arrays.asList("ADMIN", "SUB_USER", "ACCESS_MANAGE_CLIENTS");
    public static final List<String> listRegisterClients = Arrays.asList("ADMIN", "SUB_USER",
            "ACCESS_REGISTER_CLIENTS");
